    ...
    function initializePublicity() {
        ...
        var Publicity = {
            ...
            createComponents: function () {
                    ...
                    render: function () {
                        return (
                            <div ref="myPosterCard"
                                ...
                                {this.props.dataBranding ?<Publicity.PosterCard.Brand data={this.props.data} /> : '' }
                            </div>
                ...
                Publicity.PosterCard.Brand = React.createClass({
                    render: function () {

                        return (
                            <div className="card-branding">
                                <span className="brand-name">{ this.props.data.brand }</span>
                                <div clasName="cf" />
                            </div>
                        );
                    }
            ...
            renderCard: function (cardNode) {
                ...
                React.render(
                    <Publicity.PosterCard pollInterval={ parseInt($(cardNode).attr('data-poll')) || 15000 }
            ...
            renderArrangement: function (ads, load_more, cols, offset, gridNode) {
                ...
                React.render(
                    ...
                    <Publicity.PosterArrangement data={ ads } loadMore={load_more}
