...
(function ($, window, document, React, undefined) {
    ...
    var Publicity = {
                    ...
                    return (
                        <div ref="myPosterCard"
                            ...
                            <div
                                ...
                                <Publicity.PosterCard.Action data={this.props.data} creative={this.props.dataCreative} />
        ...
        renderArrangement: function (ads, load_more, cols, offset, gridNode) {
            ...
            React.render(
                <Publicity.PosterArrangement data={ ads } loadMore={load_more} loadCount={ (ads.length / cols) * cols}
                                             loadOffset={ offset }/>,
                gridNode
            );
